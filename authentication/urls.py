...
from .views import UserCreationAPIView, SuperuserCreationAPIView, DoctorUserCreationAPIView
...
urlpatterns = [
    ...
    path('doctor-register', DoctorUserCreationAPIView.as_view(), name='superuser_registration'),
